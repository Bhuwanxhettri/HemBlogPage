<div>
    ...
    <nav
        class="  drop-shadow-lg w-full flex flex-wrap items-center justify-between py-3 bg-gray-900 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light">
        <div class="  container-fluid w-full flex flex-wrap items-center justify-between px-6">
            ...
            <div class="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent1">
                <a class="text-xl text-white pr-2 font-semibold" href="#">The <span
                        class="font-bold text-yellow-600 ">Bolg</span> World</a>
                <!-- Left links -->
                <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto mx-10">
                    <li class="nav-item p-2">
                        <a class="nav-link text-white" href="#">Blogs</a>
                    </li>
                    <li class="nav-item p-2">
                        <a class="nav-link text-white opacity-60 hover:opacity-80 focus:opacity-80 p-0" href="#">About
                            us</a>
                    </li>
                    <li class="nav-item p-2">
